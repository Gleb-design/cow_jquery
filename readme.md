...
# Объекты в jQuery
 http://erud.by/object_orient_program/637 
- $.
- $('a');
- $('<a>')
- $(this)
- $(function(){})
  $('a:first').mousemove(function(){
  });
- appendTo  
  $('<img>').attr('src', 'media/img/'+image).addClass('my_pic').appendTo('#picture');
- append
  $('#picture).append('<img src="asdf" class="test">');
